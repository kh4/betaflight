...
#define CRSF_MAX_PAYLOAD_SIZE   14
#define CRSF_MAX_MESSAGE_SIZE   (CRSF_MAX_PAYLOAD_SIZE+4)

struct telemetryConfig_s;
void initCrsfTelemetry(struct telemetryConfig_s *initialTelemetryConfig);
